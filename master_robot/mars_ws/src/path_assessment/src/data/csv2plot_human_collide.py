...
file_path = 'social_human_collide_index_astar_full_scene_test1.csv'
    ...
    for row in reader:
        for item in row:
            if item:
                ...
                # count += 1
# for individual static threshold = 1
...
plt.axhline(y=1.1, color='red', linestyle='--', label='Threshold')  # 添加標籤
...
save_file = 'social_human_collide_index_astar_full_scene_test1 .png'

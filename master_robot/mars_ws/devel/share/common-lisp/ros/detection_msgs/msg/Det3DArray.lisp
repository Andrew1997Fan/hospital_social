...
(cl:defclass <Det3DArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (dets_list
    :reader dets_list
    :initarg :dets_list
    :type (cl:vector detection_msgs-msg:Det3D)
   :initform (cl:make-array 0 :element-type 'detection_msgs-msg:Det3D :initial-element (cl:make-instance 'detection_msgs-msg:Det3D)))
   (pointcloud
    :reader pointcloud
    :initarg :pointcloud
...
(cl:defmethod cl:initialize-instance :after ((m <Det3DArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Det3DArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detection_msgs-msg:<Det3DArray> is deprecated: use detection_msgs-msg:Det3DArray instead.")))
...
(cl:defmethod dets_list-val ((m <Det3DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:dets_list-val is deprecated.  Use detection_msgs-msg:dets_list instead.")
  (dets_list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Det3DArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'dets_list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'detection_msgs-msg:Det3D))

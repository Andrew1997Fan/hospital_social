...
(cl:defclass <Detection2D> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (boxes
    :reader boxes
    :initarg :boxes
    :type (cl:vector detection_msgs-msg:BBox2D)
   :initform (cl:make-array 0 :element-type 'detection_msgs-msg:BBox2D :initial-element (cl:make-instance 'detection_msgs-msg:BBox2D)))
   (result_image
    :reader result_image
...
(cl:defmethod boxes-val ((m <Detection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:boxes-val is deprecated.  Use detection_msgs-msg:boxes instead.")
  (boxes m))

(cl:ensure-generic-function 'result_image-val :lambda-list '(m))
(cl:defmethod result_image-val ((m <Detection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:result_image-val is deprecated.  Use detection_msgs-msg:result_image instead.")
  (result_image m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Detection2D>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'detection_msgs-msg:BBox2D))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Detection2D>)))
  ...
  "bed6dd383d095a46e9f7803b10d5e966")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Detection2D)))
  "Returns md5sum for a message object of type 'Detection2D"
  "bed6dd383d095a46e9f7803b10d5e966")

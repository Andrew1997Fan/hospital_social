...
(cl:defmethod cl:initialize-instance :after ((m <TwistArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwistArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name human_msgs-msg:<TwistArray> is deprecated: use human_msgs-msg:TwistArray instead.")))
...
(cl:defmethod twist-val ((m <TwistArray>))

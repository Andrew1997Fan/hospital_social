...
(cl:defclass <Trajectory> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector human_msgs-msg:TrajectoryPoint)
   :initform (cl:make-array 0 :element-type 'human_msgs-msg:TrajectoryPoint :initial-element (cl:make-instance 'human_msgs-msg:TrajectoryPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Trajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name human_msgs-msg:<Trajectory> is deprecated: use human_msgs-msg:Trajectory instead.")))
...
(cl:defmethod points-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader human_msgs-msg:points-val is deprecated.  Use human_msgs-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Trajectory>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'human_msgs-msg:TrajectoryPoint))

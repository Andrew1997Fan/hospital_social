...
class HumanTrajectoryArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.trajectories.forEach((val) => {
      bufferOffset = HumanTrajectory.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HumanTrajectoryArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.trajectories[i] = HumanTrajectory.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.trajectories.forEach((val) => {
      length += HumanTrajectory.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'human_msgs/HumanTrajectoryArray';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '5ad8c3c6ea66cb744a1fc37739b7074e';
  }
  ...
  static messageDefinition() {
    ...
    human_msgs/HumanTrajectory[] trajectories
    ...
    ================================================================================
    MSG: human_msgs/HumanTrajectory
    std_msgs/Header         header
    uint64                  id
  ...
  static Resolve(msg) {
    ...
    const resolved = new HumanTrajectoryArray(null);
    ...
    if (msg.trajectories !== undefined) {
      ...
      for (let i = 0; i < resolved.trajectories.length; ++i) {
        resolved.trajectories[i] = HumanTrajectory.Resolve(msg.trajectories[i]);
      }
    }
    else {
...
module.exports = HumanTrajectoryArray;

...
"""autogenerated by genpy from human_msgs/TrackedHumanArray.msg. Do not edit."""
import codecs
import sys
...
class TrackedHumanArray(genpy.Message):
  _md5sum = "ddb513d4fa77f778f04463ac24f9c5a4"
  _type = "human_msgs/TrackedHumanArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','human_msgs/TrackedHuman[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackedHumanArray, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.humans:
        _x = val1
        buff.write(_get_struct_Qb().pack(_x.track_id, _x.state))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = human_msgs.msg.TrackedHuman()
        _x = val1
        start = end
        end += 9
        (_x.track_id, _x.state,) = _get_struct_Qb().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.segments = []
        for i in range(0, length):
          val2 = human_msgs.msg.TrackedSegment()
          start = end
          end += 1

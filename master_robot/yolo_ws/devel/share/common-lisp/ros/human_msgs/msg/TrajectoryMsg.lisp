...
(cl:defclass <TrajectoryMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (trajectory
    :reader trajectory
    :initarg :trajectory
    :type (cl:vector human_msgs-msg:TrajectoryPointMsg)
   :initform (cl:make-array 0 :element-type 'human_msgs-msg:TrajectoryPointMsg :initial-element (cl:make-instance 'human_msgs-msg:TrajectoryPointMsg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name human_msgs-msg:<TrajectoryMsg> is deprecated: use human_msgs-msg:TrajectoryMsg instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrajectoryMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'trajectory)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'human_msgs-msg:TrajectoryPointMsg))

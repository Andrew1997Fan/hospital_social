...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryPointMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryPointMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name human_msgs-msg:<TrajectoryPointMsg> is deprecated: use human_msgs-msg:TrajectoryPointMsg instead.")))

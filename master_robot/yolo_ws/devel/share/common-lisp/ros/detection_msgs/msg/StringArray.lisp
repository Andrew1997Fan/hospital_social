...
(cl:defmethod cl:initialize-instance :after ((m <StringArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detection_msgs-msg:<StringArray> is deprecated: use detection_msgs-msg:StringArray instead.")))

(cl:ensure-generic-function 'strings-val :lambda-list '(m))
(cl:defmethod strings-val ((m <StringArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:strings-val is deprecated.  Use detection_msgs-msg:strings instead.")
  (strings m))

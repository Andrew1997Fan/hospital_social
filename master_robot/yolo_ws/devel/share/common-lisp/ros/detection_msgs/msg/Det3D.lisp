...
(cl:defmethod cl:initialize-instance :after ((m <Det3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Det3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detection_msgs-msg:<Det3D> is deprecated: use detection_msgs-msg:Det3D instead.")))
...
(cl:defmethod z-val ((m <Det3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:z-val is deprecated.  Use detection_msgs-msg:z instead.")
  (z m))
...
(cl:defmethod place-val ((m <Det3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:place-val is deprecated.  Use detection_msgs-msg:place instead.")
  (place m))

(cl:ensure-generic-function 'class_name-val :lambda-list '(m))
(cl:defmethod class_name-val ((m <Det3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:class_name-val is deprecated.  Use detection_msgs-msg:class_name instead.")
  (class_name m))
...
(cl:defmethod height-val ((m <Det3D>))
...
(cl:defmethod width-val ((m <Det3D>))
...
(cl:defmethod length-val ((m <Det3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:length-val is deprecated.  Use detection_msgs-msg:length instead.")
  (length m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Det3D>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'confidence))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let* ((signed (cl:slot-value msg 'place)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Det3D>) istream)
  "Deserializes a message object of type '<Det3D>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'place) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Det3D>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 yaw~%float32 radius~%float32 confidence~%int8 place~%string class_name~%int8 class_id~%~%float32 height~%float32 width~%float32 length~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Det3D)))
  "Returns full string definition for message of type 'Det3D"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 yaw~%float32 radius~%float32 confidence~%int8 place~%string class_name~%int8 class_id~%~%float32 height~%float32 width~%float32 length~%~%~%"))

...
(cl:ensure-generic-function 'x_based-val :lambda-list '(m))
(cl:defmethod x_based-val ((m <Det3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_msgs-msg:x_based-val is deprecated.  Use walker_msgs-msg:x_based instead.")
  (x_based m))

(cl:ensure-generic-function 'y_based-val :lambda-list '(m))
(cl:defmethod y_based-val ((m <Det3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_msgs-msg:y_based-val is deprecated.  Use walker_msgs-msg:y_based instead.")
  (y_based m))

(cl:ensure-generic-function 'z_based-val :lambda-list '(m))
(cl:defmethod z_based-val ((m <Det3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_msgs-msg:z_based-val is deprecated.  Use walker_msgs-msg:z_based instead.")
  (z_based m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Det3D>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'x_based))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'y_based))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'z_based))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Det3D>) istream)
  "Deserializes a message object of type '<Det3D>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'x_based) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'y_based) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'z_based) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Det3D>)))
  ...
  "bed6a71702a2294d6df0698e7cec4d68")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Det3D)))
  "Returns md5sum for a message object of type 'Det3D"
  "bed6a71702a2294d6df0698e7cec4d68")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Det3D>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 yaw~%float32 radius~%float32 confidence~%string class_name~%int8 class_id~%~%float32 x_based~%float32 y_based~%float32 z_based~%~%float32 h~%float32 w~%float32 l~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Det3D)))
  "Returns full string definition for message of type 'Det3D"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 yaw~%float32 radius~%float32 confidence~%string class_name~%int8 class_id~%~%float32 x_based~%float32 y_based~%float32 z_based~%~%float32 h~%float32 w~%float32 l~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Det3D>))
  ...
  (cl:list 'Det3D
    ...
    (cl:cons ':x_based (x_based msg))
    (cl:cons ':y_based (y_based msg))
    (cl:cons ':z_based (z_based msg))
    (cl:cons ':h (h msg))
    (cl:cons ':w (w msg))
    (cl:cons ':l (l msg))
))

...
(cl:defmethod x_based-val ((m <Trk3D>))
...
(cl:defmethod y_based-val ((m <Trk3D>))
...
(cl:defmethod z_based-val ((m <Trk3D>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Trk3D>)))
  ...
  "0d71b71ca7bd035a3f5a8f01714b745a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Trk3D)))
  "Returns md5sum for a message object of type 'Trk3D"
  "0d71b71ca7bd035a3f5a8f01714b745a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Trk3D>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 vx~%float32 vy~%float32 yaw~%float32 radius~%float32 confidence~%int8 class_id~%float32 dangerous~%float32 x_based~%float32 y_based~%float32 z_based~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Trk3D)))
  "Returns full string definition for message of type 'Trk3D"
  (cl:format cl:nil "float32 x~%float32 y~%float32 vx~%float32 vy~%float32 yaw~%float32 radius~%float32 confidence~%int8 class_id~%float32 dangerous~%float32 x_based~%float32 y_based~%float32 z_based~%~%"))

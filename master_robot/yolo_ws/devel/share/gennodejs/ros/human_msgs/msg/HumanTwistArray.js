...
class HumanTwistArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.twists.forEach((val) => {
      bufferOffset = HumanTwist.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HumanTwistArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.twists[i] = HumanTwist.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 56 * object.twists.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HumanTwistArray(null);
    ...
    if (msg.twists !== undefined) {
      ...
      for (let i = 0; i < resolved.twists.length; ++i) {
        resolved.twists[i] = HumanTwist.Resolve(msg.twists[i]);
      }
    }
    else {
      resolved.twists = []
...
module.exports = HumanTwistArray;

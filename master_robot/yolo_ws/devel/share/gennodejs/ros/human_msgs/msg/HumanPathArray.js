...
class HumanPathArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.paths.forEach((val) => {
      bufferOffset = HumanPath.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HumanPathArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.paths[i] = HumanPath.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.paths.forEach((val) => {
      length += HumanPath.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HumanPathArray(null);
    ...
    if (msg.paths !== undefined) {
      ...
      for (let i = 0; i < resolved.paths.length; ++i) {
        resolved.paths[i] = HumanPath.Resolve(msg.paths[i]);
      }
    }
    else {
      resolved.paths = []

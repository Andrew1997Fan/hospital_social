...
class Det3D {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('x_based')) {
        this.x_based = initObj.x_based
      }
      else {
        this.x_based = 0.0;
      }
      if (initObj.hasOwnProperty('y_based')) {
        this.y_based = initObj.y_based
      }
      else {
        this.y_based = 0.0;
      }
      if (initObj.hasOwnProperty('z_based')) {
        this.z_based = initObj.z_based
      }
      else {
        this.z_based = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [x_based]
    bufferOffset = _serializer.float32(obj.x_based, buffer, bufferOffset);
    // Serialize message field [y_based]
    bufferOffset = _serializer.float32(obj.y_based, buffer, bufferOffset);
    // Serialize message field [z_based]
    bufferOffset = _serializer.float32(obj.z_based, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [x_based]
    data.x_based = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [y_based]
    data.y_based = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [z_based]
    data.z_based = _deserializer.float32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'bed6a71702a2294d6df0698e7cec4d68';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.x_based !== undefined) {
      resolved.x_based = msg.x_based;
    }
    else {
      resolved.x_based = 0.0
    }

    if (msg.y_based !== undefined) {
      resolved.y_based = msg.y_based;
    }
    else {
      resolved.y_based = 0.0
    }

    if (msg.z_based !== undefined) {
      resolved.z_based = msg.z_based;
    }
    else {
      resolved.z_based = 0.0
    }

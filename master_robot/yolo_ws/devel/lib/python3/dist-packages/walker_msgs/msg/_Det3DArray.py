...
class Det3DArray(genpy.Message):
  _md5sum = "abdac13c2ca3be63b352e2bd914408d4"
...
"""
  ...
  _slot_types = ['std_msgs/Header','walker_msgs/Det3D[]','sensor_msgs/PointCloud2','sensor_msgs/LaserScan']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.dets_list:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_b6f().pack(_x.class_id, _x.x_based, _x.y_based, _x.z_based, _x.h, _x.w, _x.l))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.class_id, _x.x_based, _x.y_based, _x.z_based, _x.h, _x.w, _x.l,) = _get_struct_b6f().unpack(str[start:end])

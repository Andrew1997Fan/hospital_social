...
"""autogenerated by genpy from human_msgs/TrackedHuman.msg. Do not edit."""
import codecs
import sys
...
class TrackedHuman(genpy.Message):
  _md5sum = "6137b5ecce7d20cb2b1e3c938818307c"
  _type = "human_msgs/TrackedHuman"
...
"""
  ...
  __slots__ = ['track_id','state','segments']
  _slot_types = ['uint64','int8','human_msgs/TrackedSegment[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = human_msgs.msg.TrackedSegment()
        start = end
        end += 1

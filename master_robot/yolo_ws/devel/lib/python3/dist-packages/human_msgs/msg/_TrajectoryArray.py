...
"""autogenerated by genpy from human_msgs/TrajectoryArray.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryArray(genpy.Message):
  ...
  _type = "human_msgs/TrajectoryArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','human_msgs/Trajectory[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = human_msgs.msg.Trajectory()
        _v13 = val1.header
        start = end
        end += 4
        ...
        val1.points = []
        for i in range(0, length):
          val2 = human_msgs.msg.TrajectoryPoint()
          _v15 = val2.transform

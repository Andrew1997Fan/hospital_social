...
"""autogenerated by genpy from human_msgs/HumanTrajectoryArray.msg. Do not edit."""
import codecs
import sys
...
class HumanTrajectoryArray(genpy.Message):
  _md5sum = "5ad8c3c6ea66cb744a1fc37739b7074e"
  _type = "human_msgs/HumanTrajectoryArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','human_msgs/HumanTrajectory[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HumanTrajectoryArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = human_msgs.msg.HumanTrajectory()
        _v16 = val1.header
        start = end
        end += 4
        ...
        _v18.points = []
        for i in range(0, length):
          val3 = human_msgs.msg.TrajectoryPoint()
          _v21 = val3.transform

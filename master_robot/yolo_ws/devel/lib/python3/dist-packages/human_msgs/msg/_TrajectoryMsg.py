...
"""autogenerated by genpy from human_msgs/TrajectoryMsg.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryMsg(genpy.Message):
  ...
  _type = "human_msgs/TrajectoryMsg"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','human_msgs/TrajectoryPointMsg[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = human_msgs.msg.TrajectoryPointMsg()
        _v11 = val1.pose
        _v12 = _v11.position
        _x = _v12
        start = end

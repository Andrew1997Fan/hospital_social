...
"""autogenerated by genpy from detection_msgs/Track3DArray.msg. Do not edit."""
import codecs
import sys
...
class Track3DArray(genpy.Message):
  _md5sum = "1bd10e6f8a6012c15fff6dcb1fd3b615"
  _type = "detection_msgs/Track3DArray"
...
float32[] intensities    # intensity data [device-specific units].  If your
                         ...
                         # the array empty.
"""
  __slots__ = ['header','trks_list','pointcloud','scan']
  _slot_types = ['std_msgs/Header','detection_msgs/Track3D[]','sensor_msgs/PointCloud2','sensor_msgs/LaserScan']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,trks_list,pointcloud,scan
    ...
    """
    if args or kwds:
      super(Track3DArray, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.trks_list is None:
        self.trks_list = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.trks_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.trks_list:
        _x = val1
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.pointcloud.is_dense, _x.scan.header.seq, _x.scan.header.stamp.secs, _x.scan.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = detection_msgs.msg.Track3D()
        _x = val1
        start = end
        end += 33
      ...
      (_x.pointcloud.is_dense, _x.scan.header.seq, _x.scan.header.stamp.secs, _x.scan.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])

...
let Track3D = require('./Track3D.js');
...
class Track3DArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.trks_list.forEach((val) => {
      bufferOffset = Track3D.serialize(val, buffer, bufferOffset);
    });
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Track3DArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.trks_list[i] = Track3D.deserialize(buffer, bufferOffset)
    }
  ...
  static datatype() {
    ...
    return 'detection_msgs/Track3DArray';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '1bd10e6f8a6012c15fff6dcb1fd3b615';
  }
  ...
  static messageDefinition() {
    ...
    detection_msgs/Track3D[] trks_list
  ...
  static Resolve(msg) {
    ...
    const resolved = new Track3DArray(null);
    ...
    if (msg.trks_list !== undefined) {
      ...
      for (let i = 0; i < resolved.trks_list.length; ++i) {
        resolved.trks_list[i] = Track3D.Resolve(msg.trks_list[i]);
      }
    }
    else {
      resolved.trks_list = []
